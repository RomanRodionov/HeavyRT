...
struct BVH2_LRFT : public ISceneObject
{
  BVH2_LRFT(const char* a_builderName = "cbvh_embree2") : m_builderName(a_builderName) {}
  ~BVH2_LRFT() override {}

  const char* Name() const override { return "BVH2_LRFT"; }

...
struct BVHNode16 // unpacked from single uint4 in shaders in fact
{
  half4 minXYZmaxX;
  half2 maxYZ;
  uint  leftOffset;
...
struct BVH2_LOFT_16 : public ISceneObject
{
  BVH2_LOFT_16(const char* a_builderName = "cbvh_embree2") : m_builderName(a_builderName) {}
  ~BVH2_LOFT_16() override {}

  const char* Name() const override { return "BVH2_LOFT_16"; }
...
//protected:
  ...
  std::vector<BVHNode16, aligned<BVHNode16, 64> > m_allNodes16;

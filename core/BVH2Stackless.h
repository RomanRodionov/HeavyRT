...
// main class
//
struct BVH2Stackless : public ISceneObject
{
  BVH2Stackless(const char* a_builderName = "cbvh_embree2") : m_builderName(a_builderName) {}
  ~BVH2Stackless() override {}

  const char* Name() const override { return "BVH2Stackless"; }
...
//protected:
  ...
  virtual size_t AppendTreeData(const std::vector<cbvh::BVHNode>& a_nodes, const std::vector<uint32_t>& a_indices, 
